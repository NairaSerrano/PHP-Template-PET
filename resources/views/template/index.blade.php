        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href='/sobre' class="nav-item nav-link {{Request::is('sobre')? 'active':'' }}">Sobre</a>
                    <a href='/servicos' class="nav-item nav-link {{Request::is('servicos')? 'active':'' }}">Seviços</a>
                    <a href='/precos' class="nav-item nav-link {{Request::is('precos')? 'active':'' }}">Preços</a>
                    <a href='/reservas' class="nav-item nav-link {{Request::is('reservas')? 'active':'' }}">Reservas</a>
                    <a href='/contato' class="nav-item nav-link {{Request::is('contato')? 'active':'' }}">Contato</a>
        </nav>
    </div>
    <!-- Navbar End -->
